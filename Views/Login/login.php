...
<html lang="es">
  <head>
    ...
    <link rel="shortcut icon" href="<?= media() ?>/template/img/favicon.ico" type="image/x-icon">
      ...
      <div class="login-box">
        ...
        <form class="login-form" name="formLogin" id="formLogin" action="">
          ...
          <div class="form-group btn-container">
            <button type="submit" class="btn btn-primary btn-block"><i class="fa fa-sign-in-alt mr-1 fa-lg fa-fw"></i>SIGN IN</button>
          </div>
        </form>
        <form id="formRecetPass" name="formRecetPass" class="forget-form" action="">
          ...
          <div class="form-group">
            ...
            <input id="txtEmailReset" name="txtEmailReset" class="form-control" type="text" placeholder="Correo">
          </div>
          <div class="form-group btn-container">
